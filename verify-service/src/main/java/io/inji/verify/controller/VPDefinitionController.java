...
public class VPDefinitionController {
    ...
    final VPDefinitionService vpDefinitionService;

    public VPDefinitionController(VPDefinitionService vpDefinitionService) {
        this.vpDefinitionService = vpDefinitionService;
    }

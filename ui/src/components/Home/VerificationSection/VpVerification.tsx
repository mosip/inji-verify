...
import { QrCodeOutLine, QrIcon, ScanOutline } from "../../../utils/theme-utils";
import { QRCodeSVG } from "qrcode.react";
import { useVerifyFlowSelector } from "../../../redux/features/verification/verification.selector";
import Loader from "../../commons/Loader";

export const VpVerification = () => {
  const qrSize = window.innerWidth <= 1024 ? 250 : 360;
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col mt-10 lg:mt-0 pt-0 pb-[100px] lg:py-[42px] px-0 lg:px-[104px] text-center content-center justify-center">
          ...
          <div
                ...
                style={{ backgroundImage: `url(${!RequestUri ? ScanOutline : QrCodeOutLine })`}}
              >
              {!RequestUri ? (
                <>

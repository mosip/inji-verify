...
public class UiConstants {
	...
	public static final String FILE_FORMAT_CONSTRAINTS_TEXT = 
	...
	public static final String ERROR_UNSUPPORTED_FORMAT = "No MultiFormat Readers were able to detect the QR code.";

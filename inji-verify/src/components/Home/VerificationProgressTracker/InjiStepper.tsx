                    ...
                    steps.map((step, index) => (
                        <>
                            <div className="flex items-center">
                                <div
                                    className={`text-center rounded-full w-6 h-6 flex items-center justify-center font-normal text-normal text-[12px] leading-5  ${isStepCompleted(index) ? "bg-[#FF7F00] text-white border-1 border-none" : "bg-white text-[#FF7F00] border-[1px] border-[#FF7F00]"}`}
                                >
                                    {index + 1}
                                </div>

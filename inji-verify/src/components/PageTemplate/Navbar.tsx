...
function Navbar(props: any) {
    // Logo goes here
    return (
        <nav className="bg-white border-gray-200 px-2 sm:px-4 py-3.5 rounded dark:bg-gray-900">
            <div className="container flex flex-wrap xs:justify-start md:justify-between items-center h-[40px] mx-0">
                ...
                <div className="w-full md:block md:w-auto" id="navbar-default">
                    <ul className="flex xs:flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                        <li>
                            <a href="#"

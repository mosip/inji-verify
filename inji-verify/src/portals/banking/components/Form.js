      ...
      <div className="px-[3rem] py-[2rem] border-b border-b-[#D7D8E1]  scrollable-div">
        ...
        <div className="mt-[2.5rem]">
          ...
          <div className="flex my-6">
            <div className="w-full mr-4">
              ...
              <input
                type="text"
                value={props.userInfo.gender ?? "Male"}
                disabled
                className="p-3 w-full rounded-md text-gray-500 mb-6 mt-3"
              />
            ...
            <div className="w-full ml-4">
              ...
              <img
                ...
                src={
                  props.userInfo?.picture ? props.userInfo?.picture : "assets/images/profile.svg"
                }
              />
              {/* <img
                src="assets/images/profile.svg"
                alt="profile"
                className="mb-[7.5rem] mt-3"
              /> */}
              <span>Email</span>
              <img
                src="assets/images/asterisk.svg"
        ...
        <div className="my-4">
          ...
          <label for="signin" className="mx-0 text-[#5A7184] font-[400]">
            {" "}
            {/* {t("keep_me_sign_in")}{" "} */}I hereby declare that all the
            information provided is true and accurate. I consent to background
            verification based on my tax profile.
          </label>
        </div>
      </div>

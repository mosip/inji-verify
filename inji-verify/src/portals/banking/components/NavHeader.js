...
export default function NavHeader(props) {
  ...
  return (
    <div>
      <div className="lg:my-5 lg:mx-[6rem]">
        <div className="lg:flex block justify-between">
          <img src="assets/images/logo.svg" className="m-auto lg:m-0 my-2" alt="logo"/>
          <div className="flex">
            ...
            <div className="lg:px-[1.75rem] p-4 self-center font-bold m-auto lg:m-0 flex">
              <DropdownMenu.Root>
